...
A VS Code-like code editor for the Wisp file manager. Opens as a full-screen overlay with syntax highlighting, file tree, multiple tabs, and VS Code settings import.
...
2. Install dependencies and build:
   ...
   npm run build
   ```
3. In Wisp, go to Extensions panel > "Install from Folder"
...
├── package.json          # Manifest with wisp config + dependencies

    ...
    <div className="glass-card rounded-md p-3">
      ...
      <div className="flex items-center gap-1.5">
        <input
          ...
          className="border-xp-border/60 bg-xp-bg/60 h-8 min-w-0 flex-1 rounded-md border px-2.5 text-xs text-xp-text placeholder-xp-text-muted focus:border-xp-blue/50 focus:outline-none"
        />
      ...
      <div className="mt-2 flex items-center gap-2">
        <button
          ...
          className="flex h-7 flex-1 items-center justify-center gap-1 rounded-md border border-xp-border bg-xp-surface px-3 text-[11px] font-semibold text-xp-text transition-colors hover:bg-xp-surface-light disabled:opacity-40"
        >
        ...
        {changed.length > 0 && (
          <button
            ...
            onClick={execute}
            disabled={running}
            className="flex h-7 items-center gap-1 rounded-md bg-xp-text px-3.5 text-[11px] font-semibold text-xp-bg disabled:opacity-50"
          >
      ...
      {preview.length > 0 && (
        <div className="border-xp-border/40 mt-2 max-h-44 overflow-y-auto rounded-md border">
            ...
            >
              ...
              {r.success ? (
                <>
                  ...
                  <span
                    className="min-w-0 flex-1 truncate font-semibold text-xp-text"
                    title={r.new_name}
                  >
                    {r.new_name}
                  </span>

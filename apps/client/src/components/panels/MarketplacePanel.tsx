    ...
    return (
      <div className="flex h-32 flex-col items-center justify-center gap-2 px-4">
        ...
        <button
          ...
          className="mt-1 rounded-md border border-xp-border bg-xp-surface px-3 py-1 text-xs text-xp-text transition-colors hover:bg-xp-surface-light"
        >
          ...
          <div className="space-y-3 p-3">
            {EXTENSION_PACKS.map((pack) => {
              ...
              return (
                <div
                  key={pack.id}
                  className="border-xp-border hover:bg-xp-surface-light/50 rounded-md border p-3 transition-colors"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <h4 className="truncate text-sm font-semibold">{pack.name}</h4>
                        {pack.recommended && (
                          <span className="bg-xp-blue/20 text-xp-blue rounded-md px-1.5 py-0.5 text-[10px] font-semibold">
                            Recommended
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex flex-shrink-0 items-center gap-1.5">
                      {isFullyInstalled ? (
                        <button
                          ...
                          className="bg-xp-red/20 text-xp-red hover:bg-xp-red/30 flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-semibold transition-colors"
                        >
                          {isInstalling ? (
                            <>
                        ...
                        <>
                          ...
                          {installedCount > 0 && (
                            <button
                              onClick={() => handleUninstallPack(pack)}
                              disabled={isInstalling || !!installingPackId}
                              className="text-xp-text-muted hover:text-xp-red hover:bg-xp-red/10 flex items-center rounded-md p-1.5 text-xs transition-colors"

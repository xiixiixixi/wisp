    ...
    <div className="flex flex-col gap-3" data-testid="external-agent-launcher">
        ...
        <div className="flex items-center justify-between gap-2 text-[11px] text-xp-text-muted">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="rounded-md p-1 text-xp-text-muted transition-colors hover:bg-xp-surface-light hover:text-xp-text disabled:opacity-40"
            >
      ...
      {agentType === 'custom-cli' && (
        <label className="flex flex-col gap-1.5 text-[11px] text-xp-text-muted">
          ...
          <input
            ...
            className="h-9 rounded-md border border-xp-border bg-xp-bg px-2.5 font-mono text-xs text-xp-text outline-none transition-colors placeholder:text-xp-text-muted focus:border-primary"
          />
        </label>
      )}
      ...
      <label className="flex flex-col gap-1.5 text-[11px] text-xp-text-muted">
        ...
        <textarea
          ...
          className="min-h-24 resize-y rounded-md border border-xp-border bg-xp-bg px-2.5 py-2 text-xs leading-5 text-xp-text outline-none transition-colors placeholder:text-xp-text-muted focus:border-primary"
        />
      </label>
      ...
      <button
        ...
        disabled={!canLaunch}
        className="inline-flex h-9 items-center justify-center gap-2 rounded-md bg-xp-blue px-3 text-xs font-semibold text-xp-on-accent transition-colors hover:bg-xp-blue-dark focus:outline-none disabled:cursor-not-allowed disabled:opacity-40"
      >

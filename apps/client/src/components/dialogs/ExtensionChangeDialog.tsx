  ...
  return (
    ...
    >
      <div
        ...
        aria-modal="true"
        tabIndex={-1}
        className="w-[420px] max-w-[90vw] rounded-md border border-xp-border bg-xp-surface p-6 outline-none"
        onKeyDown={(e) => {
      ...
      >
        ...
        <div className="mb-3 flex items-center gap-2 rounded-md border border-xp-border bg-xp-surface-light px-3 py-2.5">
          <span className="truncate text-sm font-semibold text-xp-text">{oldName}</span>
        </div>
        ...
        <div className="flex justify-end gap-2">
          ...
          <button
            type="button"
            className="rounded-md border border-xp-blue bg-xp-blue px-4 py-2 text-sm font-semibold text-xp-on-accent hover:bg-xp-blue/80"
            autoFocus

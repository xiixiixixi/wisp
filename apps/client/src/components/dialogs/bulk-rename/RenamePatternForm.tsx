  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div>
        ...
        >
          {tUi('interface.patternTemplates')}
        </label>
      ...
      <div>
        ...
        <input
          ...
          placeholder={tUi('messages.replacementExample')}
        />
        <p style={{ fontSize: 11, color: 'var(--xp-text-muted)', marginTop: 4 }}>
          <Trans
            i18nKey="messages.renameSyntax"
            t={tUi}
            components={{
              code: (
                <code
      ...
      >
        ...
        >
          ...
          {tUi('interface.regexQuickReference')}
        </button>
        {regexHelperOpen && (
          <div
            style={{
          ...
          >
            ...
            >
              {tUi('interface.clickAPatternToInsertItIntoTheSearchField')}
            </p>

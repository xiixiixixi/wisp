    ...
    <span className="ml-1.5 inline-flex flex-shrink-0 items-center gap-1 align-middle">
      {shown.map((tag) => (
        <span
          ...
          className="inline-flex h-4 max-w-24 flex-shrink-0 items-center gap-1 rounded-md border px-1.5"
          style={{
        ...
        >
          ...
          />
          <span
            className="truncate text-[9.5px] font-semibold leading-none tracking-wide"
      ...
      {rest > 0 && (
        <span className="inline-flex h-4 flex-shrink-0 items-center rounded-md border border-xp-border bg-xp-surface/60 px-1.5 text-[9.5px] font-semibold leading-none text-xp-text-muted">
          +{rest}
        </span>
      )}
    </span>

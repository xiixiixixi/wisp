...
const AdvancedSelectDialog = ({
  ...
  return (
    ...
    >
      <div
        className="flex max-h-[85vh] w-[600px] flex-col rounded-md border border-xp-border bg-xp-surface shadow-xl"
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-xp-border p-4">
          ...
          <button
            onClick={onClose}
            className="rounded-md p-1 text-xp-text-muted hover:bg-xp-surface-light hover:text-xp-text"
              ...
              >
                ...
                <div className="mb-3 flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-md border border-xp-border bg-xp-bg px-3 py-2 text-sm text-xp-text placeholder-xp-text-muted focus:border-xp-blue focus:outline-none"
                  />
                  <button
                    onClick={addExtensionsFromInput}
                    disabled={!extensionInput.trim()}
                    className="rounded-md bg-xp-accent px-3 py-2 text-sm text-[var(--xp-bg)] disabled:opacity-50"
                ...
                <div className="mb-3 flex flex-wrap gap-1.5">
                  {COMMON_FILE_TYPES.map((type) => (
                    <button
                      ...
                      className="rounded-md border border-xp-border bg-xp-bg px-2 py-1 text-xs text-xp-text transition-colors hover:bg-xp-surface-light"
                    >
                      {type.label}
                    </button>
                  ))}
                ...
                {selectedExtensions.size > 0 && (
                  <div className="flex flex-wrap gap-1">
                    {Array.from(selectedExtensions).map((ext) => (
                      <span
                        key={ext}
                        className="bg-xp-selection inline-flex items-center gap-1 rounded-md px-2 py-0.5 text-xs text-xp-text"
                      >
                        .{ext}
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    min="0"
                    placeholder="0"
                    className="flex-1 rounded-md border border-xp-border bg-xp-bg px-3 py-1.5 text-sm text-xp-text focus:border-xp-blue focus:outline-none"
                  />
                ...
                <div className="mb-3 grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-md border border-xp-border bg-xp-bg px-3 py-1.5 text-sm text-xp-text focus:border-xp-blue focus:outline-none"
                    />
                  </div>
                  <div>
                    <label className="mb-1 block text-xs text-xp-text-muted">
              ...
              >
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 rounded-md border border-xp-border bg-xp-bg px-3 py-1.5 font-mono text-sm text-xp-text placeholder-xp-text-muted focus:border-xp-blue focus:outline-none"
                  />
        ...
        <div className="border-t border-xp-border p-4">
          {/* Match preview */}
          <div className="mb-3 flex items-center justify-between rounded-md border border-xp-border bg-xp-bg px-3 py-2">
            <span className="text-sm text-xp-text">
              {selectionMode === 'invert'
                ? t('explorer.advancedSelect.filesAfterInvert')
                : t('explorer.advancedSelect.filesMatching')}
            </span>
            <span className="text-lg font-semibold text-xp-text">
              {matchCount}{' '}
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              ...
              className="rounded-md bg-xp-accent px-4 py-2 text-sm text-[var(--xp-bg)] transition-colors hover:bg-xp-accent-hover disabled:opacity-50"
    ...
    >
      <label className="flex cursor-pointer select-none items-center gap-2 p-3">
        <input
          ...
          className="rounded-md border-xp-border accent-xp-accent"
        />
        <span
          className={`text-sm font-semibold ${enabled ? 'text-xp-text' : 'text-xp-text-muted'}`}
        >
          {title}
        </span>
      </label>

...
Wisp connects to Google Drive so you can browse, upload, download, and manage cloud files alongside your local filesystem.
...
5. Wisp stores the refresh token in your system keychain
...
When browsing a Google Drive folder, the context menu includes all standard Drive operations alongside Wisp actions like preview and copy path.
...
- Wisp requests the `drive.file` and `drive.readonly` scopes

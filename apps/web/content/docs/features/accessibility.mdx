...
Wisp is designed to be usable by everyone. This page documents the accessibility features available across the application.
...
Wisp uses semantic ARIA roles throughout the UI:

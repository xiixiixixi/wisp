...
Wisp provides built-in Git support powered by the `git2` Rust crate, giving you repository management directly within the file explorer.

## Repository Detection

When you navigate into a directory, Wisp automatically checks whether it (or any parent directory) is a Git repository. If a repository is detected:

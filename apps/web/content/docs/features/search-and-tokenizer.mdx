...
Wisp includes a powerful search engine that tokenizes file contents and builds an inverted index for instant full-text search.
...
Wisp can parse natural language queries and extract structured filters:
...
When Ollama is available, Wisp can generate AI descriptions for files that don't contain searchable text:

...
Wisp includes a full SSH/SFTP client that lets you browse and manage files on remote servers as if they were local.
...
Wisp maintains a connection pool with session caching for performance. Connections are automatically cleaned up when:

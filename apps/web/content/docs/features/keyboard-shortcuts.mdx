...
Wisp is designed for keyboard-driven workflows with extensive, fully customizable shortcut support.
...
Wisp supports multiple shortcut profiles. Each profile contains a complete set of key bindings.
...
When adding or modifying a shortcut, Wisp checks for conflicts:

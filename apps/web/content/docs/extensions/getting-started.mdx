...
This guide walks you through creating, building, and installing your first Wisp extension.

## Prerequisites

- [Node.js](https://nodejs.org/) v18 or later
- npm, yarn, or pnpm
- Wisp installed on your machine
...
```bash
npx create-wisp-extension my-first-extension
```
...
```
my-first-extension/
├── package.json          ← npm config + wisp manifest
├── src/
...
Extension metadata lives in the `wisp` field of `package.json`:
...
```json
{
  ...
  "wisp": {
    ...
    "version": "1.0.0",
    "author": "Your Name",
    "description": "A simple Wisp extension",
    "icon": "🔧",
...
```typescript
import { Extension, ExtensionContext } from '@wisp/extension-sdk';
...
This rebuilds automatically when you save changes. Combined with Wisp's hot reload, you can see changes without restarting the app.
...
1. Wisp copies your extension files into its extensions directory
...
- [SDK Reference](./sdk) — `Extension` base class, `WispAPI`, and utilities

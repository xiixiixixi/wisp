...
The Wisp Extension SDK (`@wisp/extension-sdk`) provides high-level registration APIs, React hooks, UI components, base classes, and type definitions for building extensions.
...
3. Dispatches `wisp-theme-register` CustomEvent
...
```typescript
import { SidebarTab, useCurrentPath, type WispAPI } from '@wisp/extension-sdk';
...
Register a custom file editor. When a user opens a file for editing, Wisp checks registered editors for a match.
...
```typescript
import { useCurrentPath } from '@wisp/extension-sdk';
...
```typescript
import { useSelectedFiles } from '@wisp/extension-sdk';
...
```typescript
import { navigateTo } from '@wisp/extension-sdk';
...
```typescript
import { Button } from '@wisp/extension-sdk';
...
```typescript
import { Input } from '@wisp/extension-sdk';
...
```typescript
import { Select } from '@wisp/extension-sdk';
...
```typescript
import { Toggle } from '@wisp/extension-sdk';
...
```typescript
import { Spinner } from '@wisp/extension-sdk';
...
```typescript
import { Panel } from '@wisp/extension-sdk';
...
```typescript
import { Card } from '@wisp/extension-sdk';
...
```typescript
import { Extension, registerExtension } from '@wisp/extension-sdk';
...
**Allowed:** `React`, `ReactDOM`, `WispSDK`, `document`, `console`, `crypto.subtle`, `setTimeout`/`setInterval`, `CustomEvent`, `CSS`.
